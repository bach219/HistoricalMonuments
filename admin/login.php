...
if (isset($_POST['Login'])) {
    ...
    if (is_array($rs) && !empty($rs)) {
        ...
        $_SESSION['Password'] = "<h3 style='color: red'>Error-Wrong password !</h3>";
        goto end;
    }

    // Báo lỗi khi tên đăng nhập sai
    $_SESSION['Email'] = "<h3 style='color: red'>Error-Wrong email !</h3>";
    goto end;
}
end:
?>
