...
if (isset($_SESSION['username']) && $_SESSION['username']) {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($id) {
            ...
            db_q($sql);
            echo "Delete success Banner_ID = $id!";
            exit();
        }
    }
    if (isset($_GET['table'])) {
    ...
    $result = "select count(`banner_id`) as `total` from `banner`";
    ?>

    <?php include_once('header.php'); ?>

    <div class="content">
        <span class="glyphicon glyphicon-list" style="font-size: 30px;"> Banner</span>
        <br><br>
        <div id="box" >
            <p>
    <?php if ($_SESSION['level'] == 1) { ?>
                    <a class="button" href="banner_add.php" data-toggle="tooltip" title="ADD RECORD" style="font-size: 50px; color: black;"><span class="glyphicon glyphicon-plus"></span></a>
        ...
        if ($row['is_public'] == 1 || ($_SESSION['username'] == 'Admin' && $_SESSION['level'] == 1)) {
            ?>
                <tr id="<?php echo $row['banner_id']; ?>">
                    ...
                    <td><img src="../banner/<?php echo $row['banner_image']; ?>" class="img-responsive" style="width:1000%"></td>
                    <td>
                ...
                <?php }if ($_SESSION['level'] == 1 && $_SESSION['username'] == 'Admin') { ?>
                    <td>
                        <a href="banner_edit.php?edit=<?php echo $row['banner_id']; ?>" style="font-size: 20px; color: black;"><button name="edit" value="edit" type="submit"><span class="glyphicon glyphicon-edit"></span></button></a>
